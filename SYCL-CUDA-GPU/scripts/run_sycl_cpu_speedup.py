...
# set the output file
output = f"sycl_cpu_speedup_{hostname}.out"
...
if hostname == 'coffeelake1':
    ...
    vnth = [1,2,4,8,12,16,20,24,28,32,36,40,44,48]
else:
    # select the maximum number of threads
    vnth = [num_threads[-1]]

# the best conf from All_OptimizationsSYCL-CUDA.csv
maxNumber = [512,256,1024,256]
# owm-sycl-cpu;Alcoy;0.15317;0.03629;0;512
# owm-sycl-cpu;Arzua;0.22709;0.06900;0;256
# owm-sycl-cpu;BrionF;0.24979;0.03674;0;1024
# owm-sycl-cpu;BrionU;0.33541;0.03671;0;256
...
with open(output, "a") as f:
    ...
    for exe in executable_list:
        for i,mN in zip(inputs,maxNumber):
