...
__device__ __host__ __forceinline__
uint32_t morton2D( object_t xy , const real_t resolution = 65536.0 ) noexcept
{
...
__device__ __host__ __forceinline__
point_t point3D( const uint64_t code , const real_t resolution = 2097152.0 ) noexcept // 2^21
{
...
template<typename object_t>
__device__ __host__ __forceinline__
uint64_t morton3D( object_t xyz , const real_t resolution = 2097152.0 ) noexcept // 2^21
{
  xyz.x = ::fmin(xyz.x * resolution, resolution - 1.0);
  xyz.y = ::fmin(xyz.y * resolution, resolution - 1.0);
  xyz.z = ::fmin(xyz.z * resolution, resolution - 1.0);
